...
class BraunRobinson {
    ...
    calculateGameCost() {
        return this.round((this.loverCost + this.upperCost) / 2, 5);
    }
    ...
    startGameConsole() {
        ...
        return (this.showAlgoritmResult()); // возвратим цену игры
    }
